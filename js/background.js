class Background {
    ...
    loadImage(file) {
        ...
        if (!window.grid) {
            ...
            alert('Please set canvas size first before importing background image.');
            return;
        }
    ...
    setupHideBackgroundButton() {
        ...
        bgImportBtn.addEventListener('mousedown', (e) => {
        ...
        bgImportBtn.addEventListener('touchstart', (e) => {
            // Only trigger hide if image is loaded
            if (this.image) {
                handleHideStart(e);
            }
        }, { capture: true, passive: true }); // Use passive: true so it doesn't block canvas events
    ...
    setupRemoveBackgroundModal() {
        ...
        const closeBtn = document.getElementById('confirmRemoveBackgroundClose');
        const cancelBtn = document.getElementById('confirmRemoveBackgroundCancel');
        const confirmBtn = document.getElementById('confirmRemoveBackgroundConfirm');
        ...
        const handleEnd = (e) => {
            ...
            if (hasChanged && window.historyManager) {
                if (activeButton === 'image') {
                    ...
                    const actionType = activeButton === 'scale' ? 'resizeBackground' : 
                                     activeButton === 'position' ? 'moveBackground' : 
                                     'rotateBackground';
