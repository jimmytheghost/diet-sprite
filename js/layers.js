class Layers {
    ...
    setupColorPickerModal() {
        ...
        applyBtn.addEventListener('click', () => {
            ...
            if ((this.currentLayerColor || this.isChangingBackground) && this.selectedPaletteColorForLayer !== null) {
                newColor = window.SNES_PALETTE[this.selectedPaletteColorForLayer];
            } else {
                newColor = colorPicker.value;
            }
    ...
    openColorPicker(color) {
        ...
        window.SNES_PALETTE.forEach((paletteColor, index) => {
            ...
            colorDiv.addEventListener('click', () => {
                ...
                paletteGrid.querySelectorAll('.palette-color').forEach(el => el.classList.remove('selected'));
                // Select this color
                colorDiv.classList.add('selected');
                this.selectedPaletteColorForLayer = index;
    ...
    changeBackgroundColor(newColor) {
        ...
        console.log(`Changed background color from ${oldColor} to ${newColor}`);
    }
    ...
    changeLayerColor(oldColor, newColor) {
        ...
        if (changed && changes.length > 0) {
            ...
            console.log(`Changed ${changes.length} pixels from ${oldColor} to ${newColor}`);
        }
    }
